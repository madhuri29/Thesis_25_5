...
public class AboutUs extends JDialog {
	...
	public AboutUs() {
		setResizable(false);
		setTitle("About Us");
		setIconImage(Toolkit.getDefaultToolkit().getImage(AboutUs.class.getResource("/mfSimStaticGUI/resources/logo_32.png")));
		...
		JPanel pnlAboutImage1 = new ImagePanel(new ImageIcon(Main.class.getResource("/mfSimStaticGUI/resources/logo_64.png")));
		JPanel pnlAboutImage2 = new ImagePanel(new ImageIcon(Main.class.getResource("/mfSimStaticGUI/resources/dmfb_64.png")));
		JPanel pnlAboutImage3 = new ImagePanel(new ImageIcon(Main.class.getResource("/mfSimStaticGUI/resources/driver_64.png")));
		...
		JLabel lblTitle = new JLabel("DMFB Static Simulator GUI");
