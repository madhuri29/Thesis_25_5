...
4.) Download Eclipse Classic (latest 32-bit version is best)
...
6.) Install the Eclipse CDT (C++ Development Tools):
	...
	- In Eclipse, click on "Help->Install New Software..." and paste the repository address in the "Work with:" field; options should appear in the box below 
